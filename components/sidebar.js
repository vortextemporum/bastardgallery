export default function SideBar({bastardnessTypes}) {
    ...
    return (
        <div className="flex flex-col border-8 w-1/4 h-screen charriot overflow-y-auto relative inline-block bg-white">

            <p className="text-4xl text-center my-8">FILTER BY:</p>
            ...
            <p className="text-4xl text-center my-8">CALM AF TRAITS:</p>
