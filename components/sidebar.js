                        ...
                        <div className="tabs">
                            <div className="border-b tab">
                                <div className="border-l-2 border-transparent relative">
                                    ...
                                    <div className="tab-content">
                                        <div className="pl-8 pr-8 pb-5 text-grey-darkest" onChange={(e) => setBadHabitFilter(e.target.value)}>

                                            <input type="radio" id="ALL" name="badhabit" value="ALL" defaultChecked />
                                            <label htmlFor="ALL"> ALL</label><br />
                                            {
                                                
                                                Object.keys(badHabitCounts).sort().map((type) => {
                                                    // console.log(bastardTypeCounts)
                                                    return (
                                                        <div key={type}>
                                                            <input type="radio" id={type} name="badhabit" value={type} />
                                                            <label htmlFor={type}> {type} ({badHabitCounts[type].length})</label><br />
                                                        </div>
